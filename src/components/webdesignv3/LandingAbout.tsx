        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <FadeIn>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold mb-6">
              Why <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#01E6DF] to-[#0149D1]">WebsiteOptimax</span>?
            </h2>
            ...
            <Button variant="hero" size="lg" className="shadow-[#01E6DF]/25 bg-[#01E6DF] text-[#0149D1] hover:bg-[#01E4DB] hover:shadow-[#01E4DB]/30">
              <Link 
                href="#" 
              ...
              <div className="grid grid-cols-2 gap-6">
                {highlights.map((item, index) => (
                  <motion.div
                    ...
                    custom={index}
                  >
                    <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#01E6DF]/20 to-[#0149D1]/20 flex items-center justify-center mx-auto mb-4">
                      <item.icon className="w-7 h-7 text-[#01E6DF]" />
                    </div>
