      ...
      {!isPlaying && (
        ...
        >
          <div className="w-16 h-16 rounded-full bg-white/90 flex items-center justify-center shadow-lg hover:bg-white transition-colors">
            <Play className="w-8 h-8 text-[#01E6DF] ml-1" fill="currentColor" />
          </div>
        </div>
      )}
    </div>
...
function TextTestimonialCard({ testimonial }: { testimonial: Testimonial }) {
  return (
    <Card className="h-full transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-[#01E6DF]/10 border-border/50 hover:border-[#01E6DF]/30 bg-card/50 backdrop-blur-sm">
      <CardContent className="p-6 flex flex-col h-full">
        ...
        <div className="flex gap-1 mb-4">
          {[...Array(testimonial.rating)].map((_, i) => (
            <Star key={i} className="h-4 w-4 fill-[#01E6DF] text-[#01E6DF]" />
          ))}
        </div>
          ...
          <div className="flex items-center gap-3">
            <div className="relative w-12 h-12 flex-shrink-0">
              <Image
                ...
                fill
                sizes="48px"
                className="rounded-full object-cover border-2 border-[#01E6DF]/20"
              />
            </div>
            <div>
...
export function WebDesign3Testimonial() {
      ...
      <div className="container relative">
        <FadeIn className="text-center mb-16">
          <h2 className="section-heading text-foreground">
            Real Reviews from{" "}
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#01E6DF] to-[#0149D1]">B2B Leaders</span>
          </h2>
