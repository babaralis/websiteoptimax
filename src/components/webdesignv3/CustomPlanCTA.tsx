...
export function CustomPlanCTA() {
  return (
    <section className="py-12 relative overflow-hidden bg-card/50 backdrop-blur-sm">
      <div className="absolute inset-0 bg-gradient-to-r from-[#01E6DF]/20 via-[#0149D1]/15 to-[#01E6DF]/20" />
      ...
      <div className="container relative z-10">
        <div className="p-8 md:p-10 text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-muted-foreground">
            <a href="tel:+16468142689" className="flex items-center gap-2 hover:text-[#01E6DF] transition-colors">
