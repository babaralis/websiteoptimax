...
export function LandingLogoSlider() {
  return (
    <section className="py-8 lg:py-12 relative overflow-hidden border-y border-[#01E6DF]/30 bg-surface/30">
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {[...logos, ...logos].map((logo, index) => (
              <div
                key={`${logo.src}-${index}`}
                className="flex items-center justify-center shrink-0 px-8 py-4 rounded-xl bg-card/50 border border-[#01E6DF]/30 h-24 w-48 md:h-28 md:w-56"
              >
                <Image
                  src={logo.src}
                  alt={logo.alt}
