...
export function LandingHero() {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      const emailData = {
        ...
        title: "FREE Quote Request (LandingHero v3)",
      ...
      trackEvent({
        action: "form_submit",
        category: "Contact",
        label: "Landing Hero v3 Quote Form",
      });
      ...
      trackEvent({
        action: "form_success",
        category: "Contact",
        label: "Landing Hero v3 Quote Completed",
      });
  ...
  return (
    <section className="relative min-h-screen flex items-center py-20 lg:py-28 overflow-hidden mobile-hero-section">
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#01E6DF]/20 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-[#0149D1]/15 rounded-full blur-3xl" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mobile-hero-grid">
          <FadeIn className="text-center lg:text-left mobile-hero-content">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6 leading-tight">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#01E6DF] to-[#0149D1]">Revenue Engine</span>
            </h1>
            ...
            <div className="mobile-hero-button">
              <button 
                className="inline-flex items-center justify-center gap-2 whitespace-nowrap font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#01E6DF] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 bg-[#01E6DF] text-white hover:bg-[#01E4DB] shadow-lg hover:shadow-xl hover:shadow-[#01E6DF]/30 hover:-translate-y-0.5 h-14 rounded-xl px-10 text-lg gap-2"
                style={{
                  animation: 'pulse-glow-teal 0.4s ease-in-out infinite',
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 mt-4">
              <p className="text-muted-foreground text-lg">We're rated <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#01E6DF] to-[#0149D1]">4.8/5</span> from <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#01E6DF] to-[#0149D1]">18,467</span> customer reviews.</p>
            </div>
          </FadeIn>
          <FadeIn delay={0.2} className="mobile-hero-form">
            <motion.div 
              id="quote-form"
              className="glass-card-premium p-8 shadow-[0_0_3px_6px_rgba(1,230,223,0.5)] border border-[#01E6DF]"
              ...
              {isSubmitted ? (
                ...
                <>
                  <h2 className="text-3xl font-display font-bold text-center mb-2">
                    Request a <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#01E6DF] to-[#0149D1]">FREE Quote</span>
                  </h2>
                          ...
                          <FormItem>
                            <FormControl>
                              <Input 
                                ...
                                className="bg-muted/50 border-border/50 h-12 focus-visible:border-[#01E6DF] focus-visible:ring-[#01E6DF]/20"
                                {...field} 
                              />
                            </FormControl>
                            <FormMessage />
                          ...
                          <FormItem>
                            <FormControl>
                              <Textarea 
                                ...
                                className="bg-muted/50 border-border/50 min-h-[100px] resize-none focus-visible:border-[#01E6DF] focus-visible:ring-[#01E6DF]/20"
                                {...field} 
                              />
                            </FormControl>
                            <FormMessage />
