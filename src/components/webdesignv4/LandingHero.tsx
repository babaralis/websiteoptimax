  ...
  const onSubmit = async (data: FormData) => {
    try {
      const emailData = {
        ...
        title: "FREE Quote Request (LandingHero v4)",
      };
      ...
      trackEvent({
        action: "form_submit",
        category: "Contact",
        label: "Landing Hero v4 Quote Form",
      });
      ...
      trackEvent({
        action: "form_success",
        category: "Contact",
        label: "Landing Hero v4 Quote Completed",
      });
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mobile-hero-grid">
          <FadeIn className="text-center lg:text-left mobile-hero-content">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6 leading-tight">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#14B8A6] to-[#84CC16]">Revenue Engine</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 mt-4">
              <p className="text-muted-foreground text-lg">We're rated <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#14B8A6] to-[#84CC16]">4.8/5</span> from <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#14B8A6] to-[#84CC16]">18,467</span> customer reviews.</p>
            </div>
          </FadeIn>
              ...
              {isSubmitted ? (
                ...
                <>
                  <h2 className="text-3xl font-display font-bold text-center mb-2">
                    Request a <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#14B8A6] to-[#84CC16]">FREE Quote</span>
                  </h2>
