...
type WebDesignV4PortfolioProps = {
  limit?: number;
};
...
export function WebDesignV4Portfolio({ limit }: WebDesignV4PortfolioProps) {
      ...
      <div className="container relative">
        <FadeIn className="text-center mb-16">
          <h2 className="section-heading text-foreground">
            Featured <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#14B8A6] to-[#84CC16]">B2B Projects</span>
          </h2>
                    ...
                    <div className="relative w-full max-h-[31.25rem] bg-gradient-to-br from-muted to-muted/50 overflow-hidden flex items-center justify-center">
                      ...
                      <div className="absolute bottom-4 right-4 z-20 opacity-0 group-hover:opacity-100 transition-opacity">
                        <div className="w-10 h-10 rounded-full bg-[#84CC16] flex items-center justify-center">
                          <ArrowUpRight className="h-5 w-5 text-[#0D9488]" />
                        </div>
                      </div>
                    </div>
                    <CardContent className="p-6">
                      <h3 className="text-xl font-semibold mb-2 group-hover:text-[#14B8A6] transition-colors">
                        {project.title}
                      </h3>
